const journey = [
    {
        ...
        institution: "PeopleNTech Internship",
    },
    {
        years: "2024",
    ...
    },
    {
        ...
        institution: "Mir Samsul Islam Polythnic Institute",
    },
]
...
const Journey = () => {
    return (
        <div className="flex flex-col">
            <h2 className="h2 mb-8">Education & <span className="text-accent">Experience</span></h2>
            {
