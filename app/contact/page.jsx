          ...
          <div className='flex flex-col xl:flex-row gap-6'>
            ...
            <div className='flex-1'>
              <form className='flex flex-col gap-6 items-start'>
                ...
                {/* select */}
                <div className="w-full">
                  <Label html='name'>I'm interested in
                    <span className='text-accent'> *</span>
                  </Label>
                ...
                {/* textarea */}
                <div className='w-full'>
                  <Label html='message'>Message
                    <span className='text-accent'> *</span>
                  </Label>
                  <Textarea name='message' id='message' placeholder='Write your message' className='min-h-[160px] bg-white/5 border-white/10 focus-visible:border-accent focus-visible:ring-accent focus-visible:ring-[1px] resize-none p-4 selection:bg-accent placeholder:text-white/50' />
                </div>
                {/* button */}
